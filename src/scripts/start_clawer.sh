...
TIME_BEGIN=$(date +%F" "%T);
echo "少看本子多开车，开始摸神社啦:                     "$TIME_BEGIN | tee -a $dir/time_log.text;
. $dir/backup.sh $dir;
. $dir/clean.sh $dir;
java -jar $dir/MagnetClawer.jar 1>$dir/out.log 2>$dir/error.log;
